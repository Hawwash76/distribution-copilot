...
| `products`           | `GET/POST /products`, `GET/PATCH/DELETE /products/:id`, `POST /products/:id/generate-profile`                                      | Full product + profile CRUD. Saving a profile (AI-generated or manual) automatically enqueues a ~90-day discovery backfill and enables ongoing monitoring for the product. |
